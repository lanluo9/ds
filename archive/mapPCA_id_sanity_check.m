...
clear
clc
% standard map-analysis params

strprovide = struct('load_neurons',1,'load_params',0,'load_ei',0);

datarun = load_data('/Volumes/dusom_fieldlab/lab/Experiments/Array/Analysis/2019-11-21-0/data002-sorted/data002-sorted',strprovide); 
datarun_s = load_data('/Volumes/dusom_fieldlab/lab/Experiments/Array/Analysis/2019-11-21-0/less_clean/data000-map/data000-map',strprovide); 
id_kept = intersect(datarun.cell_ids, datarun_s.cell_ids);
...
datarun = load_data('/Volumes/dusom_fieldlab/lab/Experiments/Array/Analysis/2019-11-21-0/data002-sorted/data002-sorted',strprovide); 
datarun_s = load_data('/Volumes/dusom_fieldlab/lab/Experiments/Array/Analysis/2019-11-21-0/high_cont/data000-map/data000-map',strprovide); 
id_kept = intersect(datarun.cell_ids, datarun_s.cell_ids);
