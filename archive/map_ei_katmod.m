function [cell_list_map, failed_cells, output_matrix] = map_ei_katmod(master_datarun, slave_datarun, varargin)
% 
% map_ei
%
...
%sort
failed_cell_count = 0;
cell_list_map = cell(2,length(master_datarun.cell_ids));
for i = 1:length(master_indices)
