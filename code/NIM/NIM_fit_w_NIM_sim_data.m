...
spikes = spk_bootstrap(4); % try fit1S first, who has highest R2 & LL. w less noise bc of bootstrapping, if there is no bias it should perform nicely
