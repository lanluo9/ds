...
on_sus_cell_ids = importdata('1121-data007-ON-sustained-id.txt'); % map ON sustained cell master id
...
tic
% for i = 1 : size(on_sus_map_ei,1) % ran for more than 42 hours w/o result
